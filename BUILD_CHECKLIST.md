...
- [x] `STRIPE_SECRET_KEY`, `STRIPE_WEBHOOK_SECRET`, payment link + price env vars → real billing (sandbox/test mode: 4 payment links + webhook endpoint created, all in `.env`; swap for live keys when going to production)
